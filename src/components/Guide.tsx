...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: "Любую операцию можно изменить или удалить в «Истории»: балансы пересчитаются сами. Аренду и подписки заведите в блоке «Каждый месяц» под расходами — они отложатся из свободных денег, пока не оплачены.",
    art: (
      <Scene>
