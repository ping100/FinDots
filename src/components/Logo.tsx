 ...
 */
const DOTS = [
  { cx: 50, cy: 29.3, color: "#22c55e", dx: 0, dy: 22, delay: 0 },
  { cx: 31.8, cy: 62.5, color: "#60a5fa", dx: 18.2, dy: -11.1, delay: 90 },
  { cx: 68.2, cy: 62.5, color: "#f97316", dx: -18.2, dy: -11.1, delay: 180 },
];
    ...
    <svg width={size} height={size} viewBox="17.5 13.4 65 65" role="img" aria-label="Findots">
      {DOTS.map((dot) => (
        <circle
          ...
          r={14.3}
          fill={dot.color}
          className={animated ? "animate-dot" : undefined}
          style={
            animated
              ? ({
