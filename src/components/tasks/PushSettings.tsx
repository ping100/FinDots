...
const HINTS: Record<PushState, string> = {
  ...
  off: "Напоминания о задачах придут в назначенное время, даже когда приложение закрыто.",
  on: "Включены на этом устройстве. Напоминания придут в назначенное время.",
};
...
/**
 * Уведомления в настройках задач: включить, проверить, выключить.
 * Включаются на каждом устройстве отдельно — у телефона своё разрешение.
 */
