-- Админка: аватарка из Google у каждого пользователя.
    ...
    'users', coalesce((
      ...
      from (
        select
          ...
          -- Почта привязанного Google: бывает другой, чем почта входа, и по
          -- ней человека узнают, когда он пишет «у меня не входит через Google».
          ...
          -- Картинка профиля Google — аватарка в админке.
