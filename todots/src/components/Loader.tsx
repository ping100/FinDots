 ...
 * загрузке мелькнувший и тут же пропавший логотип раздражает сильнее, чем
 ...
 *
 * Если связь совсем плохая, через несколько секунд появляется строчка с
 * объяснением: молчащий экран человек считает зависшим.
 */
